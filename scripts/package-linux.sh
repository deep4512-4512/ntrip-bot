...
chmod +x "$PACKAGE_ROOT/$APP_NAME" "$PACKAGE_ROOT/install.sh" "$PACKAGE_ROOT/update.sh" "$PACKAGE_ROOT/scripts/run-linux.sh" "$PACKAGE_ROOT/scripts/install-service.sh"
